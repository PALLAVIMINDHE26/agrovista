      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        {["🌾", "🌿", "🌱", "🍃"].map((emoji, i) => (
          <motion.div
            ...
            style={{ left: `${15 + i * 22}%`, top: `${20 + (i % 3) * 25}%` }}
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div>
            ...
            >
              ...
              >
                India's Most Authentic
                <span className="block text-green-300">
                  Agrotourism Platform
                </span>
              </h2>
              ...
              <div className="flex flex-wrap gap-3">
                {[
                  ...
                  <motion.span
                    ...
                    className="bg-white/10 backdrop-blur-sm border border-white/20 text-white text-sm px-4 py-2 rounded-full font-medium"
                  >
                    {f}
                  </motion.span>
                ))}
          ...
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-5">
            <p className="text-white text-sm italic leading-relaxed mb-3">
              "AgroVista completely transformed how I experience rural India.
              The farm-to-table dinner was unforgettable!"
            </p>
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500">
              Sign in to continue your agrotourism journey
            </p>
          </div>
          ...
          <button
            ...
            type="button"
            className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-200 hover:border-gray-300 text-gray-700 font-bold py-3.5 rounded-2xl transition-all hover:shadow-md mb-4 group"
          >
            {/* Google SVG icon */}
          ...
          {/* ---- EMAIL LOGIN FORM (existing logic) ---- */}
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-green-600 to-emerald-500 hover:from-green-700 hover:to-emerald-600 text-white font-black py-4 rounded-2xl transition-all duration-300 hover:scale-105 hover:shadow-xl disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:scale-100 text-base mt-2"
            >
              {loading ? (
          ...
          <div className="flex items-center justify-center gap-4 mt-8 pt-6 border-t border-gray-100">
            {["🔒 SSL Secure", "✅ Verified", "🌿 Free to join"].map((b, i) => (
